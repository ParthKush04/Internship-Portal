...
function Navbar() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-[72px] w-full max-w-6xl items-center justify-between px-4 md:px-6">
        <Link to="/" className="flex items-center gap-3">
          <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-blue-700 to-indigo-700 text-sm font-bold text-white">
            PT
          </span>
          <span className="text-base font-bold tracking-tight text-gray-900 md:text-lg">Provisioning Tech</span>
        </Link>
